...
private final class SuperRightClickStore: ObservableObject {
    ...
    private func syncToSharedConfig() {
        ...
        let renameFieldMetas = FinderRenameConfigStore.enabledFields(from: defaults).map { field in
            SuperRightClickSharedConfig.RenameFieldMeta(
                id: field.id,
                title: field.title,
